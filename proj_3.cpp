...
{/* store integers in a vector from standard input */
	...
	int token;
	// our container content variable
	...
	cout << endl << endl;/* print integers from vector */
	...
	cout << endl;/* find the largest element, manually */
	...
	cout << endl << "... and your largest integer is: " << max << endl << endl;/* exit happily */
	return 0;
}
